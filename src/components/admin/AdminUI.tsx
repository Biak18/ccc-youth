...
export const inputClass =
  "w-full rounded-lg border border-line bg-card px-3 py-2.5 text-ink shadow-sm transition-all duration-200 placeholder:text-muted hover:border-skyblue/60 hover:shadow focus:border-skyblue focus-visible:-translate-y-px focus-visible:shadow-md focus-visible:ring-4 focus-visible:ring-skyblue/20";
